...
const homepageSchema = new mongoose.Schema({
  ...
  about: { eyebrow: String, title: String, description: String, experienceYear: { type: Number, default: 2020 } },
  process: [{ number: String, title: String, text: String, order: { type: Number, default: 0 } }],
  industries: [{ name: String, active: { type: Boolean, default: true }, order: { type: Number, default: 0 } }],
  cta: { eyebrow: String, title: String, primaryText: String, primaryLink: String, secondaryText: String, secondaryLink: String },
