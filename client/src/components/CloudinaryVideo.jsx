...
export default function CloudinaryVideo({ src, poster, className = '', ...props }) {
  ...
  return <video ref={ref} className={className} poster={poster} preload="none" playsInline muted controls {...props} src={optimize(src)} data-video-active={active} aria-label={props['aria-label'] || 'Project video'} />
}
