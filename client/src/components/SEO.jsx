...
const DEFAULT_DESCRIPTION =
  'Grow With Me helps businesses build a professional digital presence through social media, creative content, video editing, graphic design, digital marketing and web design.'
...
export default function SEO({ title, description = DEFAULT_DESCRIPTION, image, path = '/' }) {
  useEffect(() => {
    const fullTitle = title
      ? `${title} — ${SITE}`
      : `${SITE} — Creative Digital Solutions Since 2020`
    ...
    set('meta[name="robots"]', 'content', 'index, follow, max-image-preview:large')
    ...
    set('meta[property="og:locale"]', 'content', 'en_IN')
