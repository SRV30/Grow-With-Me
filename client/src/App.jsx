...
function ServicesSection() {
  return (
    <section id="services" className="row-section row-light">
      <div className="row-container">
        ...
        <div className="row-service-grid">
          {services.map((service, index) => {
            ...
            return (
              <article className="row-service-card" key={service.number}>
                <div className="row-service-icon">
                  <Icon size={32} strokeWidth={1.8} />
                </div>
                <span className="row-service-number">{service.number}</span>
                <h3>{service.title}</h3>
                <p>{service.text}</p>
      ...
      <div className="row-container row-cta-grid">
        ...
        <div className="row-cta-image">
          {ctaImage ? (
            ...
            <div className="row-person-placeholder">
              <Coffee size={60} />
            </div>
          )}
        </div>
