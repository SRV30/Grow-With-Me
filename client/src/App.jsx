    ...
    <div ref={shellRef} className="site-shell">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-black/10 bg-[#f6f4ee]/85 backdrop-blur-xl">
        <nav className="container-gwm flex h-20 items-center justify-between">
          ...
          <button aria-label={menuOpen ? 'Close menu' : 'Open menu'} className="md:hidden" onClick={() => setMenuOpen(!menuOpen)}>
            {menuOpen ? <X /> : <Menu />}
          </button>
        </nav>
          ...
          <div className="container-gwm grid gap-12 py-20 lg:grid-cols-[1.15fr_.85fr] lg:items-center lg:gap-20">
            <div className="hero-copy relative z-10">
              ...
              <div className="mt-9 flex flex-wrap gap-4">
                <a href="#contact" className="yellow-button magnetic">Get Started <ArrowUpRight size={17} /></a>
                <a href="#work" className="dark-button magnetic">View Our Work <ArrowDownRight size={17} /></a>
              </div>
            </div>
            <div className="relative mx-auto w-full max-w-[540px] [perspective:1200px]">
              ...
              <div className="hero-card relative overflow-hidden border border-black bg-[#111] p-3">
                <div className="relative aspect-[4/5] overflow-hidden bg-[#e9e6dc]">
                  ...
                  <div className="absolute left-[10%] top-[12%] max-w-[75%] text-[clamp(3rem,8vw,6.5rem)] font-black leading-[.78] tracking-[-.08em]">MAKE<br /><span className="text-[#f5d90a]" style={{ WebkitTextStroke: '2px #111' }}>NOISE.</span></div>
                  <div className="absolute bottom-7 left-7 right-7 flex items-end justify-between border-t border-black pt-4 text-[10px] font-bold uppercase tracking-[.18em]"><span>Grow With Me</span><span>01 / 06</span></div>
                </div>
              </div>
            </div>
          </div>
