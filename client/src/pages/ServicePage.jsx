...
const serviceContent = {
  'social-media-management': {
    ...
    description: 'We plan, create and manage consistent social content that makes your brand look professional and keeps your audience engaged.',
  ...
  'reels-video-editing': {
    ...
    description: 'From raw footage to polished reels, we create fast, clear and engaging short-form videos built for modern social platforms.',
  ...
  'graphic-designing': {
    ...
    description: 'We create branded graphics that communicate clearly, look professional and keep your visual identity consistent.',
  ...
  'social-media-advertising': {
    ...
    description: 'We help turn paid social campaigns into focused growth opportunities through clear creative and audience-first campaign thinking.',
  ...
  'business-promotion': {
    ...
    description: 'We combine creative content and promotional thinking to help products, offers and local businesses get noticed.',
  ...
  'website-design': {
    ...
    description: 'We design modern, responsive websites that communicate your value clearly and create a professional first impression.',
  ...
  return (
    <main ref={root} className="service-page">
        ...
        <div className="service-hero-grid">
          ...
          <div className="service-hero-card" data-service-media>
            ...
            <div className="service-card-content">
              ...
              <strong>Creative work.<br />Business purpose.</strong>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="service-related service-container">
        <div className="service-related-heading"><div><p className="service-eyebrow">Selected work</p><h2>Work made for this service.</h2></div><Link to={`/work?service=${encodeURIComponent(service.title)}`}>View all <ArrowUpRight size={15} /></Link></div>
        {relatedProjects.length ? (
          <div className="service-related-grid">
            {relatedProjects.map((project) => <Link to={`/work/${project.slug}`} key={project._id || project.slug} className="service-project-card">
              {project.coverImage?.url ? <CloudinaryImage src={project.coverImage.url} alt={project.coverImage.alt || project.title} className="service-project-image" width={900} sizes="(max-width: 800px) 100vw, 33vw" blur={false} /> : <div className="service-project-placeholder">GWM</div>}
              <div><span>{project.year || 'Project'}</span><strong>{project.title}</strong></div>
            </Link>)}
          </div>
      ...
      <section className="service-final-cta">
        <div className="service-container"><p className="service-eyebrow">Ready when you are</p><h2>Let&apos;s build something that gets noticed.</h2><Link to="/#contact" className="service-primary-button">Start your project <ArrowUpRight size={17} /></Link></div>
      </section>
    </main>
  )
}
